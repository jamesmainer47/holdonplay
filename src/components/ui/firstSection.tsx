...
export default function FirstSection(){
    return (
        <div className="h-dvh flex flex-col justify-center relative align-middle self-center text-justify lg:text-center items-center bg-[url('/hero.jpg')] bg-cover ">
            ...
            <p className="lg:px-100 p-5 lg:text-3xl  sm:px-10 ">Get your Music on Spotify, Apple Music, TikTok, Youtube, Tidal, Tencent and more.</p>
            <p className="lg:px-100 p-5 lg:text-3xl sm:px-10 ">Keep 100% ownership of your music and stay in control of your career. Unlimited Releases starting at Tsh: 77,000/=</p>
