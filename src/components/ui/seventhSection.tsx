    ...
    return (
        <div className="flex flex-col lg:flex-row sm:flex-col p-20  text-center items-center self-center justify-center  sm:dvh  bg-black">
            <div className="flex flex-col">
                ...
                <button className="p-2 m-2 bg-blue-400 font-bold border-blue-400 rounded-full border-2 hover:bg-blue-800 "><Link href="/signUp">SIGN UP NOW</Link></button>
                <button className="p-2 m-2 bg-black font-bold border-blue-400 rounded-full border-2 hover:bg-blue-800 "><Link href="/watchVideo">WATCH VIDEO</Link></button>
            </div>
