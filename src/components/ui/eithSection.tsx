...
export default function EightSection(){
    return (
        <div className="flex flex-col p-10 md:flex-col lg:flex-row sm:flex-col justify-center items-center  bg-black text-center">
            ...
            <div className=" flex flex-col max-w-100">
                ...
                <ul className="list-disc text-left pl-10 p-5">
                ...
                <button className="p-2 m-2 w-fit self-center border-blue-400 bg-blue-400 rounded-full border-2">
                    <Link href="/earnings">LEARN MORE</Link>
                </button>
                <button className="p-2 m-2 border-blue-400 w-fit self-center bg-gray-800 rounded-full border-2">
