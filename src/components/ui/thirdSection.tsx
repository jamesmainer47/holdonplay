...
export default function ThirdSection(){
    return (
        <div className="flex flex-col lg:px-100 p-7 justify-center items-center h-140  bg-black ">
            ...
            <button className="p-2 border-2 bg-blue-400 w-fit self-center hover:bg-blue-800  border-blue-400 rounded-full font-bold">
                <Link href="/sellMusic">SEE OUR DISTRIBUTION PLANS</Link>
            </button>
        </div>
